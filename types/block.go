...
// MaxCommitOverheadBytes represents the maximum size of a commit without any commitSigs.
// It is calculated as 82 bytes for BlockID, 8 bytes for Height, and 4 bytes for Round.
const (
